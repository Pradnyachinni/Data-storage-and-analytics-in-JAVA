...
PreparedStatement ps = c1.prepareStatement("select * from stud");
...
JTable tb;
String headers [] = {"Name","DOB","Address","RollNo","Class","Contact","Updated"};
...
String class1=rs.getString(5);
String contact=rs.getString(6);
String updated=rs.getString(7);
row = new String[] {name,DOB,address,Roll,class1,contact,updated};
dtm.addRow(row);
}
